...
public:
	...
	void DrawPSprite (player_t * player,pspdef_t *psp,fixed_t sx, fixed_t sy, int cm_index, bool hudModelStep, int OverrideShader, float nativeAlpha = 1.0f, unsigned int nativeMaterialFlags = 0, uint32 nativeStyle = 0);
